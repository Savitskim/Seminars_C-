...
double TheEquation(double x, double bx1, double kx1, double bx2, double kx2)
{
    return kx1 * x + bx1;
}
...
if (k1 != k2)
{
    double x = Math.Round(Calculating(b1, k1, b2, k2), 1, MidpointRounding.ToZero);
    double y = Math.Round(TheEquation(x, b1, k1, b2, k2), 1, MidpointRounding.ToZero);
